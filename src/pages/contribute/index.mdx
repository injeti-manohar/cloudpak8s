---
title: Contributing to Cloud Paks At Work
description: Guide for contributing content to Cloud Paks At Work
keywords: 'ibm,cloud pak,contribute'
---

<PageDescription>

Anyone can contribute to the Cloud Paks At Work site, whether you are 
an IBM'er or not.
...
submission.
   - There is a way to run a development instance of the Cloud Paks 
At Work site on your local machine. Follow the instructions in 
