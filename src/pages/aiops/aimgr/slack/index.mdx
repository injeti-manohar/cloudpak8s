...
Create a Slack app, by going to [https://api.slack.com/apps](https://api.slack.com/apps) and clicking **Create an App**. In the pop-up dialog, enter an App Name and specify which Workspace it will be connected to and then click Create App.
